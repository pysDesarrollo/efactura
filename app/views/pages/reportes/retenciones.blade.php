...
<div class="section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="titulo-pagina"> <i class="fa fa-bar-chart-o"></i> Reporte de retenciones</div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-1">
...
<script type="text/javascript">
    ...
    $("#imprimir").click(function(){
        if($("#desde").val()!="" && $("#hasta").val()!=""){
            window.open('{{URL::to("reportes/retencionesPdf")}}?desde='+$("#desde").val()+"&hasta="+$("#hasta").val())
        }else{
            bootbox.alert("Por favor, seleccione las fechas Desde y Hasta para generar el reporte")
        }
